...
interface IHealthServiceService
  extends grpc.ServiceDefinition<grpc.UntypedServiceImplementation> {
  getHealth: IHealthServiceService_IGetHealth;
}

interface IHealthServiceService_IGetHealth
  extends grpc.MethodDefinition<
    health_health_pb.HealthRequest,
    common_common_pb.ServerHealthResponse
  > {
...
export interface IHealthServiceServer
  ...
  getHealth: grpc.handleUnaryCall<
    health_health_pb.HealthRequest,
    common_common_pb.ServerHealthResponse
  >;
}
...
export interface IHealthServiceClient {
  getHealth(
    ...
    callback: (
      ...
      response: common_common_pb.ServerHealthResponse
    ) => void
...
export class HealthServiceClient
  extends grpc.Client
  implements IHealthServiceClient
{
  constructor(
    address: string,
