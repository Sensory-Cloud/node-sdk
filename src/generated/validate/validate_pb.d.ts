...
export class DurationRules extends jspb.Message {
  ...
  setNotInList(
    value: Array<google_protobuf_duration_pb.Duration>
  ): DurationRules;
  addNotIn(
    value?: google_protobuf_duration_pb.Duration,
    index?: number
