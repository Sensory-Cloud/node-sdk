...
export class ValidateRecognitionRequest extends jspb.Message {
  ...
  static toObject(
    includeInstance: boolean,
    msg: ValidateRecognitionRequest
  ): ValidateRecognitionRequest.AsObject;
  static extensions: { [key: number]: jspb.ExtensionFieldInfo<jspb.Message> };
  static extensionsBinary: {
    [key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message>;
  };
...
export class LivenessRecognitionResponse extends jspb.Message {
  ...
  static toObject(
    includeInstance: boolean,
    msg: LivenessRecognitionResponse
  ): LivenessRecognitionResponse.AsObject;
  static extensions: { [key: number]: jspb.ExtensionFieldInfo<jspb.Message> };
  static extensionsBinary: {
    [key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message>;
  };
...
export class ValidateRecognitionConfig extends jspb.Message {
  ...
  static toObject(
    includeInstance: boolean,
    msg: ValidateRecognitionConfig
  ): ValidateRecognitionConfig.AsObject;
  static extensions: { [key: number]: jspb.ExtensionFieldInfo<jspb.Message> };
  static extensionsBinary: {
    [key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message>;
  };
