...
interface IFileService_IGetInfo
  extends grpc.MethodDefinition<
    v1_file_file_pb.FileRequest,
    v1_file_file_pb.FileInfo
  > {
...
interface IFileService_IGetCatalog
  extends grpc.MethodDefinition<
    v1_file_file_pb.FileCatalogRequest,
    v1_file_file_pb.FileCatalogResponse
  > {
...
interface IFileService_IGetCompleteCatalog
  extends grpc.MethodDefinition<
    v1_file_file_pb.FileCompleteCatalogRequest,
    v1_file_file_pb.FileCatalogResponse
  > {
...
interface IFileService_IDownload
  extends grpc.MethodDefinition<
    v1_file_file_pb.FileRequest,
    v1_file_file_pb.FileResponse
  > {
...
export interface IFileServer extends grpc.UntypedServiceImplementation {
  getInfo: grpc.handleUnaryCall<
    ...
    v1_file_file_pb.FileInfo
  >;
  getCatalog: grpc.handleUnaryCall<
    v1_file_file_pb.FileCatalogRequest,
    v1_file_file_pb.FileCatalogResponse
  >;
  getCompleteCatalog: grpc.handleUnaryCall<
    v1_file_file_pb.FileCompleteCatalogRequest,
    v1_file_file_pb.FileCatalogResponse
  >;
...
export interface IFileClient {
  getInfo(
    request: v1_file_file_pb.FileRequest,
    callback: (
      error: grpc.ServiceError | null,
      response: v1_file_file_pb.FileInfo
    ) => void
  ...
  getCatalog(
    request: v1_file_file_pb.FileCatalogRequest,
    callback: (
      error: grpc.ServiceError | null,
      response: v1_file_file_pb.FileCatalogResponse
    ) => void
  ): grpc.ClientUnaryCall;
  getCatalog(
    request: v1_file_file_pb.FileCatalogRequest,
  ...
  getCompleteCatalog(
    request: v1_file_file_pb.FileCompleteCatalogRequest,
    callback: (
      error: grpc.ServiceError | null,
      response: v1_file_file_pb.FileCatalogResponse
    ) => void
  ...
  download(
    request: v1_file_file_pb.FileRequest,
    options?: Partial<grpc.CallOptions>
  ): grpc.ClientReadableStream<v1_file_file_pb.FileResponse>;
  download(
    request: v1_file_file_pb.FileRequest,
    metadata?: grpc.Metadata,
    options?: Partial<grpc.CallOptions>
