...
export class FileRequest extends jspb.Message {
  getFile(): string;
  setFile(value: string): FileRequest;

  hasCategory(): boolean;
  clearCategory(): void;
  getCategory(): VersionedFileCategory | undefined;
  setCategory(value?: VersionedFileCategory): FileRequest;
  getOffset(): number;
  setOffset(value: number): FileRequest;
...
export class FileResponse extends jspb.Message {
  ...
  setInfo(value?: FileInfo): FileResponse;

  hasChunk(): boolean;
  clearChunk(): void;
  getChunk(): FileChunk | undefined;
  setChunk(value?: FileChunk): FileResponse;
  getComplete(): boolean;
  setComplete(value: boolean): FileResponse;
...
export class FileCatalogRequest extends jspb.Message {
  ...
  setCategoriesList(value: Array<VersionedFileCategory>): FileCatalogRequest;
  addCategories(
    value?: VersionedFileCategory,
    index?: number
  ...
  static toObject(
    includeInstance: boolean,
    msg: FileCatalogRequest
  ): FileCatalogRequest.AsObject;
  static extensions: { [key: number]: jspb.ExtensionFieldInfo<jspb.Message> };
  static extensionsBinary: {
    [key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message>;
  };
...
export class FileCompleteCatalogRequest extends jspb.Message {
  getTenantid(): string;
  setTenantid(value: string): FileCompleteCatalogRequest;

  serializeBinary(): Uint8Array;
  toObject(includeInstance?: boolean): FileCompleteCatalogRequest.AsObject;
  static toObject(
    includeInstance: boolean,
    msg: FileCompleteCatalogRequest
  ): FileCompleteCatalogRequest.AsObject;
  static extensions: { [key: number]: jspb.ExtensionFieldInfo<jspb.Message> };
  static extensionsBinary: {
    [key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message>;
  };
...
export class FileCatalogResponse extends jspb.Message {
  ...
  setCatalogList(value: Array<FileCatalog>): FileCatalogResponse;
  ...
  static toObject(
    includeInstance: boolean,
    msg: FileCatalogResponse
  ): FileCatalogResponse.AsObject;
  static extensions: { [key: number]: jspb.ExtensionFieldInfo<jspb.Message> };
  static extensionsBinary: {
    [key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message>;
  };
...
export class FileChunk extends jspb.Message {
  ...
  setBytes(value: Uint8Array | string): FileChunk;
  getOffset(): number;
  setOffset(value: number): FileChunk;
...
export class FileInfo extends jspb.Message {
  getFile(): string;
  setFile(value: string): FileInfo;
  getAbsolutepath(): string;
  setAbsolutepath(value: string): FileInfo;
  getSize(): number;
  setSize(value: number): FileInfo;
  getContenttype(): string;
  setContenttype(value: string): FileInfo;
  getHash(): string;
  setHash(value: string): FileInfo;
  getTenantid(): string;
  setTenantid(value: string): FileInfo;
...
export class FileCatalog extends jspb.Message {
  ...
  setFilesList(value: Array<FileInfo>): FileCatalog;
  addFiles(value?: FileInfo, index?: number): FileInfo;

  hasCategory(): boolean;
  clearCategory(): void;
  getCategory(): VersionedFileCategory | undefined;
  setCategory(value?: VersionedFileCategory): FileCatalog;
...
export class VersionedFileCategory extends jspb.Message {
  ...
  setCategory(value: FileCategory): VersionedFileCategory;
  getVersion(): string;
  setVersion(value: string): VersionedFileCategory;

  serializeBinary(): Uint8Array;
  toObject(includeInstance?: boolean): VersionedFileCategory.AsObject;
  static toObject(
    includeInstance: boolean,
    msg: VersionedFileCategory
  ): VersionedFileCategory.AsObject;
  static extensions: { [key: number]: jspb.ExtensionFieldInfo<jspb.Message> };
  static extensionsBinary: {
    [key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message>;
  };
