...
export class EnrollDeviceRequest extends jspb.Message {
  ...
  static toObject(
    ...
    msg: EnrollDeviceRequest
  ): EnrollDeviceRequest.AsObject;
...
export class RenewDeviceCredentialRequest extends jspb.Message {
  ...
  static toObject(
    includeInstance: boolean,
    msg: RenewDeviceCredentialRequest
  ): RenewDeviceCredentialRequest.AsObject;
  static extensions: { [key: number]: jspb.ExtensionFieldInfo<jspb.Message> };
  static extensionsBinary: {
    [key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message>;
  };
  static serializeBinaryToWriter(
    message: RenewDeviceCredentialRequest,
    writer: jspb.BinaryWriter
  ): void;
...
export class DeviceGetWhoAmIRequest extends jspb.Message {
  ...
  static toObject(
    includeInstance: boolean,
    msg: DeviceGetWhoAmIRequest
  ): DeviceGetWhoAmIRequest.AsObject;
  static extensions: { [key: number]: jspb.ExtensionFieldInfo<jspb.Message> };
  static extensionsBinary: {
    [key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message>;
  };
...
export class DeviceListResponse extends jspb.Message {
  ...
  static toObject(
    includeInstance: boolean,
    msg: DeviceListResponse
  ): DeviceListResponse.AsObject;
  static extensions: { [key: number]: jspb.ExtensionFieldInfo<jspb.Message> };
  static extensionsBinary: {
    [key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message>;
  };
