...
interface IDeviceServiceService
...
interface IDeviceServiceService_IEnrollDevice
  extends grpc.MethodDefinition<
    v1_management_device_pb.EnrollDeviceRequest,
    v1_management_device_pb.DeviceResponse
  > {
...
interface IDeviceServiceService_IRenewDeviceCredential
  extends grpc.MethodDefinition<
    v1_management_device_pb.RenewDeviceCredentialRequest,
    v1_management_device_pb.DeviceResponse
  > {
...
interface IDeviceServiceService_IGetWhoAmI
  extends grpc.MethodDefinition<
    v1_management_device_pb.DeviceGetWhoAmIRequest,
    v1_management_device_pb.DeviceResponse
  > {
...
interface IDeviceServiceService_IGetDevice
  extends grpc.MethodDefinition<
    v1_management_device_pb.DeviceRequest,
    v1_management_device_pb.GetDeviceResponse
  > {
...
interface IDeviceServiceService_IGetDevices
  extends grpc.MethodDefinition<
    v1_management_device_pb.GetDevicesRequest,
    v1_management_device_pb.DeviceListResponse
  > {
...
interface IDeviceServiceService_IUpdateDevice
  extends grpc.MethodDefinition<
    v1_management_device_pb.UpdateDeviceRequest,
    v1_management_device_pb.DeviceResponse
  > {
...
interface IDeviceServiceService_IDeleteDevice
  extends grpc.MethodDefinition<
    v1_management_device_pb.DeviceRequest,
    v1_management_device_pb.DeviceResponse
  > {
...
export interface IDeviceServiceServer
  ...
  enrollDevice: grpc.handleUnaryCall<
    v1_management_device_pb.EnrollDeviceRequest,
    v1_management_device_pb.DeviceResponse
  >;
  renewDeviceCredential: grpc.handleUnaryCall<
    v1_management_device_pb.RenewDeviceCredentialRequest,
    v1_management_device_pb.DeviceResponse
  >;
  getWhoAmI: grpc.handleUnaryCall<
    ...
    v1_management_device_pb.DeviceResponse
  >;
  getDevice: grpc.handleUnaryCall<
    v1_management_device_pb.DeviceRequest,
    v1_management_device_pb.GetDeviceResponse
  >;
  getDevices: grpc.handleUnaryCall<
    v1_management_device_pb.GetDevicesRequest,
    v1_management_device_pb.DeviceListResponse
  >;
  updateDevice: grpc.handleUnaryCall<
    v1_management_device_pb.UpdateDeviceRequest,
    v1_management_device_pb.DeviceResponse
  >;
  deleteDevice: grpc.handleUnaryCall<
    v1_management_device_pb.DeviceRequest,
    v1_management_device_pb.DeviceResponse
  >;
}
...
export interface IDeviceServiceClient {
  enrollDevice(
    request: v1_management_device_pb.EnrollDeviceRequest,
    callback: (
      error: grpc.ServiceError | null,
      response: v1_management_device_pb.DeviceResponse
    ) => void
  ...
  renewDeviceCredential(
    request: v1_management_device_pb.RenewDeviceCredentialRequest,
    callback: (
      error: grpc.ServiceError | null,
      response: v1_management_device_pb.DeviceResponse
    ) => void
  ...
  getWhoAmI(
    request: v1_management_device_pb.DeviceGetWhoAmIRequest,
    callback: (
      error: grpc.ServiceError | null,
      response: v1_management_device_pb.DeviceResponse
    ) => void
  ...
  getDevice(
    request: v1_management_device_pb.DeviceRequest,
    callback: (
      error: grpc.ServiceError | null,
      response: v1_management_device_pb.GetDeviceResponse
    ) => void
  ): grpc.ClientUnaryCall;
  getDevice(
    request: v1_management_device_pb.DeviceRequest,
  ...
  getDevices(
    request: v1_management_device_pb.GetDevicesRequest,
    callback: (
      error: grpc.ServiceError | null,
      response: v1_management_device_pb.DeviceListResponse
    ) => void
  ): grpc.ClientUnaryCall;
  getDevices(
    request: v1_management_device_pb.GetDevicesRequest,
  ...
  updateDevice(
    request: v1_management_device_pb.UpdateDeviceRequest,
    callback: (
      error: grpc.ServiceError | null,
      response: v1_management_device_pb.DeviceResponse
    ) => void
...
export class DeviceServiceClient
  extends grpc.Client
  implements IDeviceServiceClient
{
  constructor(
    address: string,
