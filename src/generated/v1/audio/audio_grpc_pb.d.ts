...
interface IAudioModelsService
  extends grpc.ServiceDefinition<grpc.UntypedServiceImplementation> {
  getModels: IAudioModelsService_IGetModels;
}

interface IAudioModelsService_IGetModels
  extends grpc.MethodDefinition<
    v1_audio_audio_pb.GetModelsRequest,
    v1_audio_audio_pb.GetModelsResponse
  > {
...
export interface IAudioModelsClient {
  getModels(
    request: v1_audio_audio_pb.GetModelsRequest,
    callback: (
      error: grpc.ServiceError | null,
      response: v1_audio_audio_pb.GetModelsResponse
    ) => void
...
interface IAudioBiometricsService
  extends grpc.ServiceDefinition<grpc.UntypedServiceImplementation> {
  createEnrollment: IAudioBiometricsService_ICreateEnrollment;
  authenticate: IAudioBiometricsService_IAuthenticate;
}

interface IAudioBiometricsService_ICreateEnrollment
  extends grpc.MethodDefinition<
    v1_audio_audio_pb.CreateEnrollmentRequest,
    v1_audio_audio_pb.CreateEnrollmentResponse
  > {
...
interface IAudioBiometricsService_IAuthenticate
  extends grpc.MethodDefinition<
    v1_audio_audio_pb.AuthenticateRequest,
    v1_audio_audio_pb.AuthenticateResponse
  > {
...
export interface IAudioBiometricsServer
...
export class AudioBiometricsClient
  extends grpc.Client
  implements IAudioBiometricsClient
{
  constructor(
    address: string,
    credentials: grpc.ChannelCredentials,
...
interface IAudioEventsService_IValidateEvent
  extends grpc.MethodDefinition<
    v1_audio_audio_pb.ValidateEventRequest,
    v1_audio_audio_pb.ValidateEventResponse
  > {
...
interface IAudioEventsService_ICreateEnrolledEvent
  extends grpc.MethodDefinition<
    v1_audio_audio_pb.CreateEnrolledEventRequest,
    v1_audio_audio_pb.CreateEnrollmentResponse
  > {
...
interface IAudioEventsService_IValidateEnrolledEvent
  extends grpc.MethodDefinition<
    v1_audio_audio_pb.ValidateEnrolledEventRequest,
    v1_audio_audio_pb.ValidateEnrolledEventResponse
  > {
...
export interface IAudioEventsServer extends grpc.UntypedServiceImplementation {
  validateEvent: grpc.handleBidiStreamingCall<
    v1_audio_audio_pb.ValidateEventRequest,
    v1_audio_audio_pb.ValidateEventResponse
  >;
  createEnrolledEvent: grpc.handleBidiStreamingCall<
    v1_audio_audio_pb.CreateEnrolledEventRequest,
    v1_audio_audio_pb.CreateEnrollmentResponse
  >;
  validateEnrolledEvent: grpc.handleBidiStreamingCall<
    v1_audio_audio_pb.ValidateEnrolledEventRequest,
    v1_audio_audio_pb.ValidateEnrolledEventResponse
  >;
}
...
export interface IAudioEventsClient {
  validateEvent(): grpc.ClientDuplexStream<
    v1_audio_audio_pb.ValidateEventRequest,
    v1_audio_audio_pb.ValidateEventResponse
  >;
  validateEvent(
  ...
  validateEvent(
    ...
    v1_audio_audio_pb.ValidateEventResponse
  >;
  createEnrolledEvent(): grpc.ClientDuplexStream<
    v1_audio_audio_pb.CreateEnrolledEventRequest,
    v1_audio_audio_pb.CreateEnrollmentResponse
  >;
  createEnrolledEvent(
  ...
  createEnrolledEvent(
    ...
    v1_audio_audio_pb.CreateEnrollmentResponse
  >;
  validateEnrolledEvent(): grpc.ClientDuplexStream<
    v1_audio_audio_pb.ValidateEnrolledEventRequest,
    v1_audio_audio_pb.ValidateEnrolledEventResponse
  >;
...
interface IAudioTranscriptionsService
  extends grpc.ServiceDefinition<grpc.UntypedServiceImplementation> {
  transcribe: IAudioTranscriptionsService_ITranscribe;
}

interface IAudioTranscriptionsService_ITranscribe
  extends grpc.MethodDefinition<
    v1_audio_audio_pb.TranscribeRequest,
    v1_audio_audio_pb.TranscribeResponse
  > {
...
export interface IAudioTranscriptionsServer
  extends grpc.UntypedServiceImplementation {
  transcribe: grpc.handleBidiStreamingCall<
    v1_audio_audio_pb.TranscribeRequest,
    v1_audio_audio_pb.TranscribeResponse
  >;
}
...
export interface IAudioTranscriptionsClient {
  transcribe(): grpc.ClientDuplexStream<
    v1_audio_audio_pb.TranscribeRequest,
    v1_audio_audio_pb.TranscribeResponse
  >;
  transcribe(
...
export class AudioTranscriptionsClient
  extends grpc.Client
  implements IAudioTranscriptionsClient
{
  constructor(
    address: string,
    credentials: grpc.ChannelCredentials,
...
interface IAudioSynthesisService
  extends grpc.ServiceDefinition<grpc.UntypedServiceImplementation> {
  synthesizeSpeech: IAudioSynthesisService_ISynthesizeSpeech;
}

interface IAudioSynthesisService_ISynthesizeSpeech
  extends grpc.MethodDefinition<
    v1_audio_audio_pb.SynthesizeSpeechRequest,
    v1_audio_audio_pb.SynthesizeSpeechResponse
  > {
...
export interface IAudioSynthesisServer
  extends grpc.UntypedServiceImplementation {
  synthesizeSpeech: grpc.handleServerStreamingCall<
    v1_audio_audio_pb.SynthesizeSpeechRequest,
    v1_audio_audio_pb.SynthesizeSpeechResponse
  >;
}
...
export interface IAudioSynthesisClient {
  synthesizeSpeech(
    request: v1_audio_audio_pb.SynthesizeSpeechRequest,
    options?: Partial<grpc.CallOptions>
  ): grpc.ClientReadableStream<v1_audio_audio_pb.SynthesizeSpeechResponse>;
  synthesizeSpeech(
    request: v1_audio_audio_pb.SynthesizeSpeechRequest,
    metadata?: grpc.Metadata,
    options?: Partial<grpc.CallOptions>
...
export class AudioSynthesisClient
  extends grpc.Client
  implements IAudioSynthesisClient
{
  constructor(
    address: string,
    credentials: grpc.ChannelCredentials,
